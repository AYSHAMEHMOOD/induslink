...
export default function RegisterPage()
 {
  ...
  return (
    <div className="flex items-center justify-center h-[100dvh] bg-white">
      <div className="bg-white py-10 px-2 shadow-[0_0_8px_rgba(0,0,0,0.3)] mb-3 rounded-lg">
        <Image
        ...
        <div className="flex flex-col gap-6">
          ...
          <button
            ...
            className="bg-[#2f4f4f] hover:bg-[#1f3838] text-white mb-3 text-lg font-medium py-3 px-30 rounded-lg shadow-md transition-all duration-300"
          >
            Buyer
          </button>
        </div>
