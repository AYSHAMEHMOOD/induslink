...
export default function SellerPage() {
  ...
  return (
    <div className="h-[100dvh] bg-white text-black overflow-scroll z-0">
      <div className='bg-white p-1 mb-3'>
        <Image src="/images/logo.png" alt="Logo" width={100} height={100}/>
      </div>
      <div className="m-auto relative h-[350px] mx-2 my-3">
        <Image src="/images/PHOTO-2025-10-14-20-33-23.jpg" alt="mainimage" fill className="w-full rounded-lg"/>
      </div>
      <div className='bg-white m-2 rounded-lg p-2 shadow-[0_0_8px_rgba(0,0,0,0.3)]'>
        <div className='flex items-center'>
          <Image src="/images/PHOTO-2025-10-14-20-33-23.jpg" alt='companylogo' width={120} height={120} className='border-1 border-black rounded-lg mr-4'/>
