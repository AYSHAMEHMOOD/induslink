...
export default function Services(){
    ...
    return(
        <div className="flex flex-col h-[220px]">
            ...
            <div className="flex justify-between my-1 bg-white overflow-hidden overflow-x-scroll">
                <div className="flex flex-col gap-2 bg-white rounded-lg shadow-[0_0_8px_rgba(0,0,0,0.3)] group relative pb-2">
                    <Image src="/images/PHOTO-2025-10-14-20-33-23.jpg" alt="services" width={200} height={200} className="rounded-lg"/>
