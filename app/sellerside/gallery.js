...
export default function Gallery(){
    ...
    return(
        <div className="flex flex-col h-[220px]">
            ...
            <div className="flex my-1 overflow-x-scroll w-[100%] justify-between">
                <div className="relative group h-[170px] w-[200px]">
                    <Image src="/images/PHOTO-2025-10-15-11-01-47.jpg" alt="interior image" fill className="rounded-lg"/>
